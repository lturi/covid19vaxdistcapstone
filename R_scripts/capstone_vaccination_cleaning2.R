...
df.all<-data.frame(read_csv(sprintf("%s/gcnb-epac.csv.csv",working_date)))
...
df.all$Rate.AsianPartial.Per.100K <-df.all$Partially.Covered.Asian/df.all$TOT_NHAAC *100000
df.all$Rate.AsianFull.Per.100K <-df.all$Fully.Covered.Asian/df.all$TOT_NHAAC *100000
df.all$Rate.PIPartial.Per.100K <-df.all$Partially.Covered.Pacific.Islander/df.all$TOT_NHNAC *100000
df.all$Rate.PIFull.Per.100K <-df.all$Fully.Covered.Pacific.Islander/df.all$TOT_NHNAC *100000
df.all$Rate.WhitePartial.Per.100K <-df.all$Partially.Covered.White/df.all$TOT_NHWA *100000
df.all$Rate.WhiteFull.Per.100K <-df.all$Fully.Covered.White/df.all$TOT_NHWA *100000
...
df.all$Compare.Partial.PA <-df.all$Rate.PIPartial.Per.100K >= df.all$Rate.Partially.Covered.per.100.000
df.all$Compare.Full.PA <- df.all$Rate.PIFull.Per.100K >= df.all$Rate.Fully.Covered.per.100.000
df.all$Compare.Partial.Asian <-df.all$Rate.AsianPartial.Per.100K >= df.all$Rate.Partially.Covered.per.100.000
df.all$Compare.Full.Asian <- df.all$Rate.AsianFull.Per.100K >= df.all$Rate.Fully.Covered.per.100.000
df.all$Compare.Partial.White <-df.all$Rate.WhitePartial.Per.100K >= df.all$Rate.Partially.Covered.per.100.000
df.all$Compare.Full.White <- df.all$Rate.WhiteFull.Per.100K >= df.all$Rate.Fully.Covered.per.100.000
...
df.all<-subset(df.all,select=-c(County.Population,Partially.Covered,Fully.Covered,TOT_POP,TOT_BAC,TOT_IAC,TOT_H,
                                ...
                                Partially.Covered.Pacific.Islander,Fully.Covered.Pacific.Islander,Partially.Covered.Asian,Fully.Covered.Asian,
                                Partially.Covered.White,Fully.Covered.White,
                                O65Partial,O65Full))
